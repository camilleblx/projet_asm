          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <div class="page-header row no-gutters py-4">
              <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title">Gérer les pubs sonores</h3>
              </div>
            </div>
            <!-- End Page Header -->
            <div class="row">
              <div class="col">
                <div class="card card-small mb-4">
                  <div class="card-header border-bottom">
                    ...
                    <br>
                    <button class="btn btn-primary btn-sm" @click="ModalAjoutPubsSonore()"><i class="fa fa-plus"></i> Ajouter</button>
                    <br>
                    <br>
                    <input type="text" class="form-control form-control-sm" v-model="rech_pubs_sonores" placeholder="Rechercher une pubs..." aria-describedby="basic-addon1">
                  </div>
                  <div class="card-body p-0 pb-3 text-center">
                    <table class="table mb-0">
                      ...
                      <tbody>
                        <tr v-for="pub in listePubsSonoresFiltre">
                          <td>{{ ($index + 1) }}</td>
                          <td>{{pub.intitule}}</td>
