...
(function ($) {
  $(document).ready(function () {
    ...
    // Type de pubs
    var data_statistiques_types_pubs = [];
    var statistiques_types_pubs = [];
    $.ajax({
        url:"data.php?cas=statistiques-types-pubs",
        type:"POST",
        data:{},
        success:function(res){
          data_statistiques_types_pubs = JSON.parse(res);
          statistiques_types_pubs[0] = data_statistiques_types_pubs[0]["count"];
          statistiques_types_pubs[1] = data_statistiques_types_pubs[1]["count"];
          statistiques_types_pubs[2] = data_statistiques_types_pubs[2]["count"];

          var ubdData = {
            datasets: [{
              hoverBorderColor: '#ffffff',
              data: statistiques_types_pubs,
              backgroundColor: [
                'rgba(0,123,255,0.9)',
                'rgba(0,123,255,0.5)',
                'rgba(0,123,255,0.3)'
            ...
            labels: ["Olfactives", "Sonores", "Visuels"]
          };
